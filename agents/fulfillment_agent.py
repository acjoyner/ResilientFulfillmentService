...
from tools.fulfillment_tools import check_fulfillment_health, inspect_recent_app_logs, get_prometheus_metrics
...
def get_fulfillment_agent_config():
    ...
    return {
        ...
        "tools": [check_fulfillment_health, inspect_recent_app_logs, get_prometheus_metrics]
    }
